...
const basePalette = {
  ...
  blueTint: "#3B82F620",
  blackSteal: "#161616",
  blackStealLight: "rgba(34, 34, 34, 0.7)",
  yellowCard: "#F5C518",
  gray50: "#FAFAFA",
  gray75: "#F9F9F9",
  gray100: "#F9FAFB",
...
export const LIGHT_COLORS = withLegacyAliases({
  ...
  text: {
    ...
    subText: basePalette.gray750,
    subtle: basePalette.night600,
...
export const DARK_COLORS = withLegacyAliases({
  ...
  brand: {
    ...
    primaryContrast: basePalette.white,
    gold: CLUB_GOLD,
    tint: "rgba(228,213,78,0.18)",
    border: "rgba(228,213,78,0.18)",
    secondaryTint: "rgba(128,0,0,0.42)",
    tertiaryTint: "rgba(228,213,78,0.18)",
    tertiary: basePalette.gray100,
  },
  backgrounds: {
  ...
  text: {
    primary: basePalette.white,
    secondary: basePalette.gray300,
    muted: basePalette.gray350,
    dark: basePalette.gray400,
    subtle: basePalette.gray100,
    subText: basePalette.gray350,
    inverse: basePalette.white,
