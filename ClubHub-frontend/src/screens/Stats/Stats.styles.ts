...
export const styles = StyleSheet.create({
  ...
  playerName: { fontSize: 14, fontWeight: "600", marginVertical: 4, flexShrink: 1,
  flexWrap: "wrap", },
  ...
  playerInfo: { flex: 2, flexDirection: "row", alignItems: "center", gap: 8,overflow: "hidden", minWidth: 0, },
