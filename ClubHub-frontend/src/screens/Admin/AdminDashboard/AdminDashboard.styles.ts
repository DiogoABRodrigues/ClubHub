...
export const styles = StyleSheet.create({
  ...
  header: { paddingTop: 24, paddingBottom: 16, paddingHorizontal: 16, backgroundColor: 'rgba(14,165,233,0.1)' },
  headerTop: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  headerTitle: { fontSize: 20, fontWeight: '700', color: '#fff', marginBottom: 2 },
  headerSubtitle: { fontSize: 12, color: '#999' },
  headerIcon: { width: 48, height: 48, borderRadius: 24, backgroundColor: '#0ea5e9', alignItems: 'center', justifyContent: 'center' },
  ...
  statCard: { flexBasis: '48%', backgroundColor: '#1f1f1f', borderRadius: 12, padding: 12, marginBottom: 8 },
  ...
  quickActionCard: { flexBasis: '48%', backgroundColor: '#1f1f1f', borderRadius: 12, padding: 12, marginBottom: 8 },
  ...
  quickActionTitle: { fontSize: 14, fontWeight: '600', color: '#fff', marginBottom: 2 },
  quickActionDesc: { fontSize: 12, color: '#999' },

  recentActivity: { backgroundColor: '#1f1f1f', borderRadius: 12, overflow: 'hidden' },
  activityItem: { flexDirection: 'row', alignItems: 'center', gap: 8, padding: 12, borderBottomWidth: 1, borderBottomColor: '#333' },
