      ...
      <View style={styles.header}>
        <View style={styles.headerTop}>
          <View>
            ...
            <Text style={styles.headerSubtitle}>FC Titans Management Portal</Text>
          </View>
        ...
        <View>
          ...
          <View style={styles.recentActivity}>
            <View style={styles.activityItem}>
              <View style={[styles.activityIcon, { backgroundColor: 'rgba(6,182,212,0.1)' }]}>
                <Trophy width={16} height={16} color="#06b6d4" />
              </View>
              <View style={{ flex: 1 }}>
                <Text style={styles.activityText}>Match result updated: FC Titans 2-1 United Sports</Text>
                <Text style={styles.activityTime}>2 hours ago</Text>
              </View>
            </View>
            <View style={styles.activityItem}>
              <View style={[styles.activityIcon, { backgroundColor: 'rgba(14,165,233,0.1)' }]}>
                <Newspaper width={16} height={16} color="#0ea5e9" />
              </View>
              <View style={{ flex: 1 }}>
                <Text style={styles.activityText}>New article published: Young Talent Signs Contract</Text>
                <Text style={styles.activityTime}>5 hours ago</Text>
              </View>
            </View>
            <View style={styles.activityItem}>
              <View style={[styles.activityIcon, { backgroundColor: 'rgba(139,92,246,0.1)' }]}>
                <Bell width={16} height={16} color="#8b5cf6" />
              </View>
              <View style={{ flex: 1 }}>
                <Text style={styles.activityText}>Notification sent: Match starting in 1 hour</Text>
