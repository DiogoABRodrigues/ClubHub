      ...
      <View style={{ paddingHorizontal: 16, marginTop: 24 }}>
        ...
        <View style={styles.playerCard}>
          ...
          <View style={styles.tableHeader}>
            ...
            <Text style={[styles.tableHeaderText, { flex: 2, textAlign: 'right' }]}>Actions</Text>
          </View>
          ...
          {filteredPlayers.map((player) => (
            <View key={player.number} style={styles.playerRow}>
              ...
              <Text style={[styles.playerText, { flex: 4 }]}>{player.name}</Text>
              <Text style={[styles.playerTextMuted, { flex: 2 }]}>{player.position}</Text>
              <View style={{ flex: 3 }}>
                <Text
                  style={[
                    styles.playerStatus,
                    player.status === 'Active' ? styles.statusActive : styles.statusInjured,
                  ]}
                >
                  {player.status}
                </Text>
