...
export const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 20, fontWeight: '700', color: '#fff', flex: 1, marginLeft: 8 },
  addButton: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  searchIcon: { position: 'absolute', left: 8, top: '50%', transform: [{ translateY: -10 }] },
  searchInput: {
  ...
  matchActions: { position: 'absolute', top: 8, right: 8, flexDirection: 'row', gap: 8 },
  editButton: {
    padding: 6,
    backgroundColor: '#1f1f1f',
    borderRadius: 8,
