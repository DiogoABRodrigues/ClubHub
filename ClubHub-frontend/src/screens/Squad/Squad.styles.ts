...
export const styles = StyleSheet.create({
  ...
  categoryButton: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 20, borderWidth: 1, borderColor: '#ccc', marginRight: 8 },
  categoryButtonActive: { backgroundColor: '#3b82f6', borderColor: '#3b82f6' },
  categoryText: { color: '#666' },
  categoryTextActive: { color: '#fff' },
  viewToggle: { flexDirection: 'row', borderWidth: 1, borderColor: '#ccc', borderRadius: 10, overflow: 'hidden', marginBottom: 16 },
  toggleButton: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 8, gap: 4 },
